...
{{--                        <img src="{{URL::asset('/img/faqs.png')}}" style="width: 75px;">--}}
                ...
                <div class="row visible-xs hidden-md">
                    ...
                    <div class="col ">
                        {{--                                            <a href="https://www.singpass.gov.sg/singpass/retrieveaccount/retrievesingpassid" target="_blank">Forgot Singpass ID</a>--}}
                        <img src="{{URL::asset('/img/UG.png')}}" data-toggle="modal" data-target="#exampleModalUG"  style="cursor: pointer;margin-left: 3px;position:absolute;width: 90%;margin-top: 400px;" >
                        <img src="{{URL::asset('/img/FAQ.png')}}" data-toggle="modal" data-target="#exampleModalFAQ"  style="cursor: pointer;margin-left: 32px;position:static;width: 90%;margin-top: 430px;" >
