...
<div class="hidden-xs">
    ...
    <div class="col-8">
        ...
        <div class="row">
            @if(substr( $soquery->Course, -5,1) == true)
            ...
            @endif
            @if(substr( $soquery->Course, -4,1) == true)
            ...
            @if(substr( $soquery->Course, -3,1) == true)
            ...
            @if(substr( $soquery->Course, -2,1) == true)
            ...
            <div class="w-100"></div><br>
            @endif
            @if(substr( $soquery->Course, -1,1) == true)
    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-4" style="color: white;margin-left: -123px;"><h3>{{date('d F Y ',strtotime($soquery->LicenseExpiryDate))}}</h3></div>
...
<div class="visible-xs hidden-md">
    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-12" style="color: white;"><h3>{{date('d F Y ',strtotime($soquery->LicenseExpiryDate))}}</h3></div>
        </div>
    </div>
    <div class="col-12">
        <h1><b>SKILL SETS ACQUIRED</b></h1>
