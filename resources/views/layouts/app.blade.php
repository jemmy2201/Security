...
{{--@endif--}}
    ...
    <div id="app" >
        <nav class="navbar navbar-expand-md navbar-light  shadow-sm" style="background: #333333;">
            <div class="container">
                @if(Request::route()->getName() == page_update_so ||Request::route()->getName()== view_course || Request::route()->getName()== after_payment || Request::route()->getName() == default_alter_term_use || Request::route()->getName() == default_alter_term_use )
