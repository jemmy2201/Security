...
<div class="container">
    ...
    <form method="post" id="save_appointment" action="{{ route('super_user.save.book.appointment') }}" >
        @csrf
...
{{--                    <li><img src="{{URL::asset('/img/green_box.jpg')}}" style="width: 2%;"> : selected date</li>--}}
    ...
    <div class="row">
        <div class="col-2 back hidden-xs">
            ...
            <a href="{{url('/super/user/back/submission/'.$request->app_type.'/'.$request->card.'/'.$request->SentCgrades)}}" style="text-decoration:none;color: white;">
    ...
    $(function(){
        ...
        function validate_limit_schedule(eventDate) {
            ...
            if(diffDays > 60){
                ...
                $.ajax({
                    url: "{{ url('/ajax/super/user/cek/data/limit/schedule') }}",
                    type: 'POST',
                    /* send the csrf-token and the input to the controller */
