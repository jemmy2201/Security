...
<script>
    function enets(){
        ...
        var Val_b2sTxnEndURLParam = {"nric":{!!  json_encode(Session::get('nric_origin')) !!},"app_type":{!!  json_encode( $booking_schedule->app_type) !!},"card":{!!  json_encode( $booking_schedule->card_id) !!},"grand_total":{!!  json_encode( $grand_total) !!},"transaction_amount_id":{!!  json_encode($transaction_amount->id) !!},"grade_id":{!!  json_encode($gst->id) !!}};
...
{{--         </div>--}}
    ...
    <div class="row hidden-xs">
        ...
        <div class="col-10">
            ...
            <img  src="{{URL::asset('/img/payment_icon/info_enets_close.jpg')}}" id="infoenetsclose" style="cursor: pointer;width: 40%; margin-left: 60px;">
        </div>
    </div>
    ...
    <div class="visible-xs hidden-md">
        ...
        <img  src="{{URL::asset('/img/payment_icon/info_enets_close.jpg')}}" id="phoneinfoenetsclose" style="cursor: pointer;width: 50%;">
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="save_payment" action="{{ route('super_user.save.payment') }}" >
                        @csrf
                        <input type="hidden" name="card" id="card" value="{{$request->card}}">
                ...
                <div class="modal-footer">
                    @php $url_cancel=url("/super/user/cancel/payment")."/".$booking_schedule->app_type."/".$booking_schedule->card_id; @endphp
...
{{--                    </a>--}}
    ...
    <!-- Modal Check Payment-->
    <button data-toggle="modal" data-target="#Form_check_payment" style="display: none" id="check_payment"></button>
    <div class="modal fade" id="Form_check_payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog check_payment" role="document">
            <div class="modal-content">
                {{--            <div class="modal-header">--}}
                ...
                <div class="modal-body">
                    <center>
                        <i class="fa fa-info-circle fa-3x" aria-hidden="true"></i><br><br>
                        <b>
                        Payment already submitted and<br>
                        to be confirmed by USE.<br><br>
                        Check your Bank app for<br>
                        the payment submitted.
                        </b>
                    </center>
                </div>
                <div class="modal-footer footer-check-payment">
                    <center>
                        @php $landing_page=url("/super/user/landing_page"); @endphp
                        <a href="{{ $landing_page }}" style="color: inherit; text-decoration: none;">
...
<script>
    ...
    $( document ).ready(function() {
        ...
        if(CurrentDate > GivenDateRemoveEnets){
            ...
            $("#phoneinfoenetsclose").css("display", "none");
            $("#infoenetsclose").css("display", "none");
        }
    });
