...
class CreateBackupBookingSchedulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('backup_booking_schedules', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('backup_booking_schedules');
    }
}
