...
class SoQueryController extends Controller
{
    public function soquery($passid)
    {
        ...
        if (empty($soquery)){
            return  view('page_error')->with(['type_error'=>type_error_so_query,'data1'=>value_SO_IDQuery1,'data2'=>value_SO_IDQuery2,'data3'=>value_SO_IDQuery3,'image'=>'fa fa-info-circle']);
        }else{
