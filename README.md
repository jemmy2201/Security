...
4. docker build -t use-laravel-app:v1.26 . -> use-laravel-app = di cek dari docker images
5. docker tag use-laravel-app:v1.26 jemmy22/use:v1.26   -> jemmy22/use:v1 nama yang ada di docker hub
6. docker push jemmy22/use:v1.26
